link:i3_Berlin/wiki/Section-6.4-Dual-Printing[Next] 
...
Install the program as described in our https://github.com/open3dengineering/i3_Berlin/tree/master/Software/KISSlicer[git] and overwrite the .ini files with our settings. 


https://github.com/open3dengineering/i3_Berlin/wiki/Section-6.4-Dual-Printing[Next] 
