link:wiki/Section-2-Assembly-of-the-Y-Unit[Next]
...
link:wiki/Section-1.1-History[Section 1.1]: The History of the RepRap project +

link:wiki/Section-1.2-Tools-and-Parts[Section 1.2]: The Tools and Parts you need to build an i3 Berlin +

link:wiki/Section-1.3-Preparing-Casings[Section 1.3]: The building starts with gluing the electronics cases +
