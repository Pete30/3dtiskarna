...
* Adjust the platform accurately to the LEFT nozzle with a piece of paper, as described in link:wiki/Section-5.4-Calibrating-the-Print-Platform[Section 5.4].
