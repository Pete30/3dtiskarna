link:wiki/Section-1.3-Preparing-Casings[Next]
...
This is the list of all the parts you will find in the box if you bought a kit or workshop through http://www.laydrop.com/en/[Laydrop]. A full Bill of Materials can be found link:blob/master/BOM.csv[here]
