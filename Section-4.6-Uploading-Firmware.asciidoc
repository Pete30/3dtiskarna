...
* Connect the display. 
** NOTICE: If the screens tays blue after you uploaded the Firmware. You did connect the two plugs on the back of the Display in the wrong order, please swap them.
